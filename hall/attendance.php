...
<link rel="dns-prefetch" href="//fonts.bunny.net">
 ...
 <table class="table table-bordered" style="width:100%">
    ...
    <?php
        ...
        <tr>
            <th  style="width:20%;">Date</th><td><?php echo $date?></td><th>Hall</th><td colspan='3'><centre> <b><?php echo $i?></b><centre></td> 
        </tr>
        <tr>
        <th>Session</th><td><?php echo $session?></td><th style="width:20%">name of the Invigilator</th><td  colspan='3'></td> 
        </tr>
